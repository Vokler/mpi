    ...
    public static void main(String[] args) {
        ...
        if (rank == 0) {
            ...
            for (int i = 1; i <= threadsCount; i++) {
                ...
                MPI.COMM_WORLD.Rsend(sendArr1, 0, sendArr1.length, MPI.INT, i, TAG);
                MPI.COMM_WORLD.Rsend(sendArr2, 0, sendArr2.length, MPI.INT, i, TAG);
            }
            ...
            System.out.println("========");
            System.out.println("ReadyBlocking result: " + (result == Utils.vectorsMultiplication(a, b)));
            long time_finish = System.currentTimeMillis();
            System.out.println("ReadyBlocking time: " + ((double) time_finish - time_start));
